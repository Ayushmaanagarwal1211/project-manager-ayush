    ...
    <div className="landing-page">
      <header className="hero-section parallax">
        <nav className="navbar" style={{height:"60px"}}>
          <h2 style={{fontSize:"20px",position:"relative",bottom:"3px"}} className='text-white'>AstraTrack</h2>
          <ul>
          <li>
  <p onClick={() => ref.current.scrollIntoView({ behavior: 'smooth' })}>
    Features
  </p>
</li>            <li style={{fontSize:"15px"}}>  <p onClick={() => about.current.scrollIntoView({ behavior: 'smooth' })}>
About Us</p></li>
  ...
  <h3>Contact Us</h3>
  <p>Email us at agarwalayushmaan88@gmail.com</p>
